...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-09 19:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cfd85fea-798b-48c1-9151-16ffedb5233e.git
$ cd cfd85fea-798b-48c1-9151-16ffedb5233e
```
